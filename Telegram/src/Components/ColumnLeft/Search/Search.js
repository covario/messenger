...
class Search extends React.Component {
    ...
    if (!chatId) {
      ...
      if (trimmedText.length >= USERNAME_LENGTH_MIN) {
        ...
        if (latinText) {
          ...
          latinTrimmedText = latinTrimmedText.startsWith('@')
            ? latinTrimmedText.substr(1)
            : latinTrimmedText;
  ...
  handleDeleteRecentlyFoundChat = async (chatId) => {
    ...
    this.setState({
      recentlyFound: {
        ...recentlyFound,
        chat_ids: recentlyFound.chat_ids.filter((x) => x !== chatId),
      },
    });
  };
  ...
  render() {
    ...
    const globalLinkChat =
      ...
      linkMessage.chat_id &&
      !linkMessage.message &&
      !globalChatsMap.has(linkMessage.chat_id) ? (
        <FoundPublicChat
        ...
        <FoundMessage
          ...
          onClick={() =>
            this.handleSelectMessage(
              linkMessage.message.chat_id,
              linkMessage.message.id,
              false,
              true,
            )
          }
