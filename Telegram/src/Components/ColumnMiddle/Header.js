...
import HeaderChatSubtitle from '../Tile/HeaderChatSubtitle';
  ...
  render() {
    ...
    control = control || (
      <div className="header-details">
        <div className="header-details__content-wrapper">
    ...
    return (
      <>
        ...
        >
          ...
          <DialogActions>
            <Button onClick={this.handleCloseDelete} variant="outlined">
              {t('Cancel')}
            </Button>
            <Button onClick={this.handleDeleteContinue} danger>
