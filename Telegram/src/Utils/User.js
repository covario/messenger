  ...
  switch (user.status['@type']) {
    ...
    case 'userStatusOffline': {
      ...
      if (wasOnline > today) {
        ...
        // other
        return `Last seen today at ${dateFormat(wasOnline, 'h:MM TT')}`;
      }
      ...
      if (wasOnline > yesterday) {
        return `Last seen yesterday at ${dateFormat(wasOnline, 'h:MM TT')}`;
      }

      return `Last seen ${dateFormat(wasOnline, 'mm/dd/yyyy')}`;
    }
